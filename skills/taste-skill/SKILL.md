...
Canonical tsx skeleton: `references/motion-skeletons.md`.
...
5. **Hero & key-section recomposition** - restructure top-of-funnel using the vocabulary in `references/pattern-vocabulary.md`.
...
**For dense product UI specifically** (dashboards, data tables, forms, multi-step flows, settings, app shells), the dedicated counterpart to this skill is **`product-ui-taste`** - use it instead of (or alongside, on a split marketing+product screen) this one. It carries the frame-first / rows-not-cards / overflow / state-matrix / data-table / a11y rigor that this skill deliberately leaves out of scope.
...
## References (vendored reference material, moved out of the body)

- `references/pattern-vocabulary.md` - the full Reference Vocabulary (pattern names the agent should know).
- `references/motion-skeletons.md` - canonical tsx code skeletons for the 5.A Sticky-Stack, 5.B Horizontal-Pan, and 5.C Scroll-Reveal Stagger patterns.
- `references/design-systems-install.md` - real install commands per design system named in Section 2.
- `references/canonical-sources.md` - canonical documentation links per design system, read these before reinventing.
- `references/liquid-glass.md` - what is and isn't official Apple Liquid Glass, plus a labeled web CSS approximation.
